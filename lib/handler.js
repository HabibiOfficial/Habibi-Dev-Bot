...
async function handleMessage(sock, message, commands, startTime, stats) {
  ...
  // Saat pesan dari akun bot sendiri (fromMe) di private chat, pengirimnya adalah bot itu sendiri.
  ...
  console.log(`[cmd] ${usedPrefix}${commandName} | from=${from} | fromMe=${message.key.fromMe}`);
